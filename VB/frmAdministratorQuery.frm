VERSION 5.00
Begin VB.Form frmAdministratorQuery 
   Caption         =   "Administrator information query and modification"
   ClientHeight    =   5790
   ClientLeft      =   120
   ClientTop       =   450
   ClientWidth     =   12360
   LinkTopic       =   "Form1"
   Picture         =   "frmAdministratorQuery.frx":0000
   ScaleHeight     =   5790
   ScaleWidth      =   12360
   ...
   End
End
Attribute VB_Name = "frmAdministratorQuery"
